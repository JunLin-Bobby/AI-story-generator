...
function StoryGame({story,onNewStory}){
    ...
    // when story is loaded, set current node to root node
    useEffect(()=>{
    ...
    //currentNodeId change, update currentNode and options
    useEffect(()=>{
        if(currentNodeId &&story&&story.all_nodes){
            ...
            setIsWinningEnding(node.is_good_ending);
            ...
            {currentNode && <div className="story-node">
                ...
                {isEnding?
                    <div className="story-ending">
                        <h3>{isWinningEnding?"Congratulation":"The End"}</h3>
