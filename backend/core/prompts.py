STORY_PROMPT = """
                ...
                4. Some paths should lead to endings (both good and losing)
                5. At least one path should lead to a good ending
                ...
                - Make sure there's at least one good ending path
